...
const TONES = [
  {
    ...
    desc: "Elevated language for high-end buyers seeking exclusivity",
  },
  {
    id: "Family & lifestyle",
    label: "Family & lifestyle",
    desc: "Warm, approachable copy focused on schools, space & community",
  },
  {
    id: "Investment opportunity",
    label: "Investment opportunity",
    desc: "ROI-focused language for investors and landlords",
  },
  {
    id: "Vacation & second home",
    label: "Vacation & second home",
    desc: "Retreat vibes for buyers seeking a getaway or short-term rental",
  },
  {
    id: "Professional / MLS",
    label: "Professional / MLS",
    desc: "Clean, factual copy for listing portals and MLS submissions",
  },
  {
    id: "First-time buyer",
    label: "First-time buyer",
    desc: "Encouraging, jargon-free tone for new homebuyers",
  },
];
  ...
  return (
    <>
      ...
      <main style={s.main}>
        ...
        <div style={s.card}>
          ...
          <div style={s.grid2}>
            <Field label="Property type">
              <select value={form.propType} onChange={set("propType")} style={s.input}>
                {["Single-family home","Condo / Apartment","Townhouse","Luxury estate","Commercial property","Land / Lot","Multi-family"].map(o => (
          ...
          <div style={{...s.grid3, marginTop: 12}}>
            <Field label="Bedrooms">
              <input style={s.input} type="number" value={form.beds} onChange={set("beds")} placeholder="4" min="0" />
            </Field>
            <Field label="Bathrooms">
              <input style={s.input} type="number" value={form.baths} onChange={set("baths")} placeholder="2.5" min="0" step="0.5" />
            </Field>
            <Field label="Year built">
              <input style={s.input} value={form.yearBuilt} onChange={set("yearBuilt")} placeholder="2005" />
            </Field>
          </div>
        </div>
          ...
          <div style={s.featuresGrid}>
            {FEATURES.map(f => (
              <div
                ...
                style={selectedFeatures.has(f) ? {...s.chip, ...s.chipActive} : s.chip}
              >
                {f}
              </div>
            ))}
        ...
        {/* Generate Button */}
        <button onClick={generate} disabled={loading} style={loading ? {...s.genBtn, ...s.genBtnDisabled} : s.genBtn}>
        ...
        {results && (
          <div style={{marginTop: 24}}>
            ...
            <div style={s.resultSection}>
              ...
              <div style={{...s.contentBox, position: "relative"}}>
                <button
                  onClick={() => copyText(`${social.headline ? social.headline+"\n\n" : ""}${social.post}`, `social-${activeSocial}`)}
...
const s = {
  ...
  toneCard: { padding: "12px 14px", border: "0.5px solid rgba(0,0,0,0.1)", borderRadius: 12, background: "#F3F2EF", cursor: "pointer", transition: "all .15s" },
